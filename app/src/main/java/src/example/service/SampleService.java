...
public interface SampleService {
     ...
     */
    @GET("/posts/{userId}")
    Call<LoginVO> getData(@Path("userId") String userId);
     ...
     */
    @GET("/posts")
    Call<List<LoginVO>> getData2(@Query("userId") String userId);
    ...
    @FormUrlEncoded
    @POST("/posts")
    Call<LoginVO> postData(@FieldMap HashMap<String, Object> param);
     ...
     */
    @PUT("/posts/1")
    Call<LoginVO> putData(@Body LoginVO param);
    ...
    @FormUrlEncoded
    @PATCH("/posts/1")
    Call<LoginVO> patchData(@Field("title") String title);
